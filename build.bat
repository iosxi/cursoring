...
set LIBS=user32.lib gdi32.lib shell32.lib advapi32.lib shcore.lib wtsapi32.lib

cl %CFLAGS% /Fobuild\ /Febuild\cursoring.exe src\main.c src\monitors.c src\mapping.c src\editor.c src\log.c /link /SUBSYSTEM:WINDOWS /MANIFEST:EMBED /MANIFESTINPUT:src\app.manifest %LIBS% || exit /b 1
