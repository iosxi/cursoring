...
cl %CFLAGS% /Fobuild\ /Febuild\LBMLite.exe src\main.c src\monitors.c src\mapping.c src\editor.c /link /SUBSYSTEM:WINDOWS /MANIFEST:EMBED /MANIFESTINPUT:src\app.manifest %LIBS% || exit /b 1
